...
<body>
    ...
    <div class="sidebar">
        ...
        <img src="{{ asset('images/Wanlanka_logo.png') }}" alt="Logo" class="logo">
        <span class="brand-name">WANLANKA</span>
    </div>
    ...
    <div class="topbar">
        ...
        <div class="topbar-right">
            ...
            <div class="user-profile">
                <img src="{{ Storage::url('profile-pictures/admin_profile.png') }}" alt="Profile" class="profile-pic">
