...
<div class="shell">
    <div class="page-header">
        <div>
            <div class="breadcrumbs"><a href="{{ route('admin.vehicles.index') }}">Vehicles</a> / <span>Edit</span></div>
            ...
            <form action="{{ route('admin.vehicles.update', $vehicle) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid split">
                    ...
                    <div>
                        ...
                        <input type="text" name="number_plate" id="number_plate" class="field" value="{{ old('number_plate', $vehicle->number_plate) }}" required>
                    </div>
                </div>
                ...
                <div class="form-grid split">
                    <div>
                        ...
                        @if ($vehicle->photo)
                            <div style="margin-bottom:8px;">
                                <img src="{{ asset('storage/' . $vehicle->photo) }}" alt="Vehicle Photo" width="120" height="80"
                                     style="object-fit:cover;border-radius:10px;border:1px solid var(--border);"
                    ...
                    <div>
                        ...
                        <input type="number" name="seat_count" id="seat_count" class="field" value="{{ old('seat_count', $vehicle->seat_count) }}" min="1" required>
                    </div>
                </div>
                ...
                <div class="form-grid split">
                    <div>
                        ...
                        <input type="text" name="model" id="model" class="field" value="{{ old('model', $vehicle->model) }}">
                    </div>
                    <div>
                        <label for="year">Year</label>
                        <input type="number" name="year" id="year" class="field" value="{{ old('year', $vehicle->year) }}" min="1900" max="{{ date('Y') }}">
                    </div>
                </div>
                ...
                <div class="form-grid split">
                    <div>
                        ...
                        <input type="text" name="color" id="color" class="field" value="{{ old('color', $vehicle->color) }}">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" class="field">{{ old('description', $vehicle->description) }}</textarea>
                </div>
