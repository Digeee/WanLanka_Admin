...
<div class="shell" id="accommodation-edit-root">
    <!-- Header -->
    <div class="page-header">
        <div>
            <div class="breadcrumbs"><a href="{{ route('admin.accommodations.index') }}">Accommodations</a> / <span>Edit</span></div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <form action="{{ route('admin.accommodations.update', $accommodation) }}" method="POST" enctype="multipart/form-data" class="form-grid">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        @if ($accommodation->image)
                            <div style="margin-bottom:8px;">
                                <img src="{{ asset('storage/' . $accommodation->image) }}" alt="Accommodation Image" width="120" onerror="this.src='{{ asset('images/placeholder.jpg') }}';" style="border-radius:10px;border:1px solid var(--border);">
                            </div>
                        @endif
...
<script>
    ...
    // Trigger change to populate on load
