...
<div class="shell" id="booking-index-root">
    <div class="page-header">
        <div>
            <div class="breadcrumbs">
                <a href="{{ route('admin.dashboard') }}">Dashboard</a> / <span>Bookings</span>
            </div>
            <h1 class="title">Individual Place Bookings</h1>
        </div>
    ...
    <div class="panel">
        <div class="panel-header">All Bookings</div>
            ...
            <div class="table-wrap">
                <table class="data">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        ...
                                        $isActive = in_array($status, ['confirmed', 'active', 'approved']);
                                    @endphp
                                    @if($isActive)
                        ...
                        @empty
                            <tr>
                                <td colspan="16" style="text-align:center; padding:20px;">No bookings found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
