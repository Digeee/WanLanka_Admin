...
<div class="shell" id="custom-package-create-root">
    <div class="page-header">
        <div>
            <div class="breadcrumbs">
                <a href="{{ route('admin.custom-packages.index') }}">Custom Packages</a> / <span>Create</span>
            </div>
            <h1 class="title">Add New Custom Package</h1>
        </div>
        <div class="actions">
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <form action="{{ route('admin.custom-packages.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="guider_id" id="guider_id" class="form-control">
                        ...
                        @foreach ($guiders as $guider)
                            <option value="{{ $guider->id }}" {{ old('guider_id') == $guider->id ? 'selected' : '' }}>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="start_location" id="start_location" class="form-control" value="{{ old('start_location') }}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="num_people" id="num_people" class="form-control" value="{{ old('num_people') }}" min="1" required>
                    </div>
                    <div class="form-group">
                        <label for="travel_date">Travel Date</label>
                        <input type="date" name="travel_date" id="travel_date" class="form-control" value="{{ old('travel_date') }}">
                    </div>
                </div>
